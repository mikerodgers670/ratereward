    ...
    <div className="landing">
      ...
      <section className="section section-dark" id="plans">
        ...
        <div className="plans-grid">
          <AnimSection className="plan-card">
            <div className="plan-chip">Starter</div>
            <div className="plan-amount">KES 500</div>
            <div className="plan-return">→ KES 1,000 back</div>
            ...
            <button className="btn-gold" onClick={() => nav('/register')}>Choose starter</button>
          </AnimSection>
          <AnimSection className="plan-card plan-card-featured">
            <div className="plan-chip plan-chip-gold">Most popular</div>
            <div className="plan-amount">KES 1,000</div>
            <div className="plan-return">→ KES 2,000 back</div>
            <ul className="plan-features">
              <li><CheckCircle2 size={15} /> Full app rating access</li>
              <li><CheckCircle2 size={15} /> One referral code</li>
              <li><CheckCircle2 size={15} /> 21-day payout cycle</li>
              <li><CheckCircle2 size={15} /> M-Pesa / bank transfer</li>
              <li><CheckCircle2 size={15} /> Priority support</li>
            </ul>
            <button className="btn-dark" onClick={() => nav('/register')}>Choose standard</button>
          </AnimSection>
        </div>
      </section>
