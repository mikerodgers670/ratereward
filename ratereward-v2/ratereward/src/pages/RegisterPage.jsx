        ...
        <div className="reg-card">
          ...
          {step === 1 && (
            <div className="form-step">
              ...
              <p className="step-sub">Both plans return exactly 2× after 21 days. No hidden fees.</p>
              <div className="plan-select-grid">
                <button
                  className={`plan-opt ${plan === 500 ? 'plan-opt-active' : ''}`}
                  onClick={() => { setPlan(500); setErrors({}) }}
                >
                  <div className="plan-opt-top">
                    <span className="plan-opt-amount">KES 500</span>
                    <span className="plan-opt-badge">Starter</span>
                  </div>
                  <div className="plan-opt-return">You receive <strong>KES 1,000</strong></div>
                  <div className="plan-opt-check">{plan === 500 && <CheckCircle2 size={20} />}</div>
                </button>
                <button
                  className={`plan-opt plan-opt-pop ${plan === 1000 ? 'plan-opt-active' : ''}`}
                  onClick={() => { setPlan(1000); setErrors({}) }}
                >
                  <div className="pop-pill">Most popular</div>
                  <div className="plan-opt-top">
                    <span className="plan-opt-amount">KES 1,000</span>
                    <span className="plan-opt-badge">Standard</span>
                  </div>
                  <div className="plan-opt-return">You receive <strong>KES 2,000</strong></div>
                  <div className="plan-opt-check">{plan === 1000 && <CheckCircle2 size={20} />}</div>
                </button>
              </div>
          ...
          {step === 4 && (
            <div className="form-step success-step">
              ...
              <div className="summary-card">
                ...
                <div className="summary-row">
                  <span>Plan</span><strong>KES {plan?.toLocaleString()}</strong>
                </div>
                <div className="summary-row">
